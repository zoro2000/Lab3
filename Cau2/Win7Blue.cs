...
namespace Eternalblue
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            if (args.Length < 1)
            {
                Console.WriteLine("Use:          Eternalblue.exe 192.168.111.140");
                Environment.Exit(0);
            }
            ...
            {
                Console.WriteLine("Target does not appears to be vulnerable!");
